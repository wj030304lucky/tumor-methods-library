const LIB_META={version:'v1.4.1',updated:'2026-09-09'};
const PAPERS=[
...
{id:'F01',module:'数字病理与Foundation Model',priority:4,title:'A pathology foundation model for cancer diagnosis and prognosis prediction',authors:'Wang X, et al.',journal:'Nature',year:2024,methods:['Foundation model','Whole-slide image','Self-supervised learning','Prognosis'],question:'能否通过大规模病理预训练建立跨癌种通用模型，同时支持诊断、分子特征和预后任务？',data:'60,530张WSI，覆盖19个解剖部位',design:'大型病理foundation model开发与多任务验证',sample:'跨机构、跨癌种病理切片',flow:'大规模病理预训练\n→ 通用表示学习\n→ 多下游任务微调/评估\n→ 癌症识别\n→ 分子特征预测\n→ 预后/治疗相关任务\n→ 外部泛化验证',result:'CHIEF展示了一个病理foundation model可跨多癌种支持诊断与预后等不同任务。',innovation:'从单任务病理AI升级为可迁移的通用病理基础模型。',limitations:'训练资源巨大；真实临床部署、亚群公平性与跨医院domain shift仍需持续验证。',reuse:'如果以后接触WSI或病理AI，重点学习其数据划分、外部验证、任务迁移和泛化评估，而不只是网络结构。',url:'https://www.nature.com/articles/s41586-024-07894-z'},
{id:'F02',module:'数字病理与Foundation Model',priority:3,title:'Towards a general-purpose foundation model for computational pathology',authors:'Chen RJ, et al.',journal:'Nature Medicine',year:2024,methods:['UNI','Self-supervised learning','Representation learning','Foundation model'],question:'能否通过超大规模自监督病理图像预训练得到可迁移到多任务的通用视觉表示？',data:'100,000+ WSI、上亿图像patch、20种主要组织类型',design:'通用病理基础模型开发与多任务benchmark',sample:'跨组织、跨机构病理数据',flow:'超大规模自监督预训练\n→ 特征抽取\n→ 多种下游病理任务\n→ few-shot / transfer evaluation\n→ 跨数据集泛化比较',result:'通用预训练特征在多个病理任务上表现出强迁移能力。',innovation:'推动病理AI从任务特定模型转向通用representation。',limitations:'下游性能仍受数据域与标签质量影响，临床解释和部署要求高。',reuse:'适合学习self-supervised foundation model如何做benchmark和跨任务验证。',url:'https://www.nature.com/articles/s41591-024-02857-3'},
{id:'F03',module:'数字病理与Foundation Model',priority:3,title:'A foundation model for clinical-grade computational pathology and rare cancers detection',authors:'Vorontsov E, et al.',journal:'Nature Medicine',year:2024,methods:['Virchow','Rare cancer detection','Generalization','OOD validation'],question:'大规模病理基础模型能否从常见癌症泛化到数据稀少的罕见癌症？',data:'大规模WSI与常见/罕见肿瘤验证集',design:'foundation model + rare disease泛化验证',sample:'覆盖9种常见和7种罕见癌症',flow:'大规模病理预训练\n→ pan-cancer检测\n→ 常见癌benchmark\n→ 罕见癌外推\n→ OOD/外部数据评估',result:'模型在pan-cancer及罕见癌检测中表现出较强泛化能力。',innovation:'把rare cancer作为foundation model泛化能力的核心压力测试。',limitations:'罕见癌标签和代表性仍有限，临床落地需前瞻验证。',reuse:'适合学习低样本、罕见病、跨域泛化的验证框架。',url:'https://www.nature.com/articles/s41591-024-03141-0'},
{id:'G01',module:'多组学与精准肿瘤',priority:3,title:'The Molecular Twin Artificial-Intelligence Platform Integrates Multi-Omic Data to Predict Outcomes for Pancreatic Adenocarcinoma Patients',authors:'Osipov A, Nikolic O, Gertych A, et al.',journal:'Nature Cancer',year:2024,methods:['Multi-omics','Machine learning','Feature integration','Prognosis'],question:'临床、基因组、转录组和蛋白组信息联合后，能否更好预测胰腺癌结局并提炼可实施生物标志物？',data:'胰腺癌多组学与临床数据，数千个特征',design:'多组学AI预后平台研究',sample:'整合约6,363个临床与多组学特征',flow:'多组学数据质控\n→ 高维特征整合\n→ 机器学习建模\n→ 模态增量价值比较\n→ 特征筛选\n→ 简约biomarker panel\n→ 结果验证',result:'多组学可以改善预后刻画，同时提示从高维模型提炼简约标志物具有临床价值。',innovation:'兼顾高维融合与可转化的简约特征集。',limitations:'高维小样本、批次效应和外部泛化仍是主要挑战。',reuse:'如果以后接触TCGA/GENIE/医院测序队列，这是很好的“多模态→简约模型”思路。',url:'https://www.nature.com/articles/s43018-023-00697-7'},
{id:'H01',module:'空间组学与肿瘤微环境',priority:2,title:'Tumour Evolution and Microenvironment Interactions in 2D and 3D Space',authors:'Mo CK, Liu J, Chen S, et al.',journal:'Nature',year:2024,methods:['Spatial transcriptomics','Single-nucleus RNA-seq','CODEX','Clonal evolution'],question:'肿瘤克隆演化与免疫/基质微环境如何在二维和三维空间中相互作用？',data:'多癌种空间转录组、单核RNA-seq、CODEX等',design:'空间多组学肿瘤演化研究',sample:'覆盖多种癌症样本',flow:'空间切片与单细胞测序\n→ 细胞类型识别\n→ CNV/克隆推断\n→ 空间邻域分析\n→ 微环境互作\n→ 2D/3D肿瘤演化重建',result:'空间位置为理解肿瘤克隆与免疫微环境关系提供了传统bulk或单细胞分析无法替代的信息。',innovation:'将克隆演化、单细胞和空间微环境统一分析。',limitations:'技术成本高、样本量通常有限、空间统计与批次校正复杂。',reuse:'现阶段更适合作为前沿方向储备，未来若接触空间组学可重点关注空间邻域与克隆互作。',url:'https://www.nature.com/articles/s41586-024-08087-4'},
{id:'M01',module:'方法规范',priority:5,title:'Transparent Reporting of Observational Studies Emulating a Target Trial—The TARGET Statement',authors:'Cashin AG, Hansford HJ, Hernán MA, et al.',journal:'JAMA',year:2025,methods:['Reporting guideline','Target trial emulation','Transparency'],question:'Target Trial Emulation研究应该怎样透明、完整地报告设计、因果目标和数据映射？',data:'报告规范',design:'共识/报告指南',sample:'不适用',flow:'报告target trial protocol\n→ estimand\n→ observational emulation\n→ assumptions\n→ analysis\n→ sensitivity analysis\n→ interpretation',result:'为TTE研究提供标准化报告框架，减少设计信息缺失和“只报模型不报目标试验”的问题。',innovation:'把目标试验协议与观察数据模拟之间的映射要求显式纳入报告规范。',limitations:'规范提高透明度但不能替代良好设计和正确因果假设。',reuse:'以后凡是做TTE，都可以直接作为Methods和Supplement的检查清单。',url:'https://jamanetwork.com/journals/jama/fullarticle/2837724'},
{id:'M02',module:'方法规范',priority:5,title:'TRIPOD+AI Statement: Updated Guidance for Reporting Clinical Prediction Models That Use Regression or Machine Learning Methods',authors:'Collins GS, Moons KGM, Dhiman P, et al.',journal:'BMJ',year:2024,methods:['Prediction model','Reporting guideline','Machine learning'],question:'预测模型研究如何规范报告数据、建模、验证和性能，覆盖传统回归与机器学习？',data:'报告规范',design:'国际共识指南',sample:'不适用',flow:'明确数据来源\n→ predictors/outcome\n→ missing data\n→ model development\n→ validation\n→ calibration/discrimination\n→ clinical use',result:'TRIPOD+AI更新了预测模型研究的透明报告要求，并覆盖机器学习场景。',innovation:'将传统统计模型和AI/ML统一纳入预测研究报告框架。',limitations:'合规报告并不保证模型低偏倚或有临床价值。',reuse:'做癌症风险预测、预后模型或ML时可以逐条核对。',url:'https://www.bmj.com/content/385/bmj-2023-078378'},
{id:'M03',module:'方法规范',priority:5,title:'PROBAST+AI: An Updated Quality, Risk of Bias, and Applicability Assessment Tool for Prediction Models Using Regression or Artificial Intelligence Methods',authors:'Moons KGM, Damen JAA, Kaul T, et al.',journal:'BMJ',year:2025,methods:['Risk of bias','Prediction model appraisal','AI'],question:'怎样系统判断癌症预测/AI研究有没有偏倚，以及是否适用于目标临床场景？',data:'偏倚评价工具',design:'国际共识工具',sample:'不适用',flow:'participants/data\n→ predictors\n→ outcome\n→ analysis\n→ risk of bias\n→ applicability',result:'提供了适用于统计和AI预测模型的结构化偏倚与适用性评估工具。',innovation:'更新传统PROBAST以覆盖AI方法与现代预测建模实践。',limitations:'需要评价者掌握预测模型方法学，部分判断仍有主观性。',reuse:'以后读任何肿瘤预测模型都建议用它做“批判性阅读”。',url:'https://www.bmj.com/content/388/bmj-2024-082505'},
{id:'A06',module:'因果推断与真实世界研究',priority:5,title:'New Methods for Two-Stage Treatment Switching Estimation',authors:'Jackson D, Ran D, Zhang F, et al.',journal:'Pharmaceutical Statistics',year:2025,methods:['treatment switching','two-stage estimation','propensity score','quantile matching'],question:'肿瘤随机试验中对照组患者转换至后续治疗后，如何估计未发生治疗转换时的生存效应？',data:'方法学研究；以 MYSTIC 免疫肿瘤试验作案例说明',design:'扩展两阶段治疗转换校正，比较不同基线时点、混杂调整与生存时间匹配方案',sample:'方法学文章；案例样本来自 MYSTIC 试验',flow:'明确治疗转换与目标 estimand\\n→ 选择第二阶段基线时点\\n→ 用倾向评分控制转换时混杂\\n→ 对转换后生存进行参数化或分位数匹配\\n→ 回推反事实生存时间\\n→ 敏感性分析与重删失检查',result:'文章提出两阶段估计的新实现方式，用于处理转换时点、后续治疗和时间依赖混杂对总生存比较的影响。',innovation:'把倾向评分与分位数匹配纳入两阶段治疗转换校正，并讨论多个临床上可解释的估计目标。',limitations:'依赖无未测混杂和生存模型等不可完全检验的假设；重删失、转换定义与后续治疗选择会改变结果。',reuse:'适合肿瘤 RCT 的 OS 敏感性分析；可与 IPCW、RPSFTM 和原始 ITT 结果并列报告。',url:'https://doi.org/10.1002/pst.2462'},
{id:'B05',module:'生存分析与疾病轨迹',priority:5,title:'Scaling and Interpreting Treatment Effects in Clinical Trials Using Restricted Mean Survival Time',authors:'Karrison T, Hu C, Dignam J',journal:'Clinical Trials',year:2025,methods:['restricted mean survival time','non-proportional hazards','absolute treatment effect','survival interpretation'],question:'比例风险假设不成立或 HR 难以临床解释时，如何用限制性平均生存时间表达治疗获益？',data:'方法学研究；使用 NRG/RTOG 前列腺癌试验示例',design:'比较 RMST 差、RMST 比、受限时间损失比及平均积分生存差等效应尺度',sample:'方法学文章；示例来自多项前列腺癌随机试验',flow:'预先选择临床有意义的截断时间 τ\\n→ 估计两组生存曲线\\n→ 计算曲线下面积得到 RMST\\n→ 报告绝对差与相对尺度\\n→ 检查 τ 的敏感性\\n→ 与 HR 和生存概率差对照解释',result:'RMST 可将整个随访区间内的生存差异转化为平均生存时间获益，尤其适用于非比例风险情形。',innovation:'系统比较多种基于 RMST 的效应尺度，并通过肿瘤试验展示不同尺度如何影响临床解释。',limitations:'结论依赖 τ 的选择和该时点前的随访支持；单一 RMST 摘要仍可能掩盖生存曲线局部差异。',reuse:'肿瘤 OS/PFS 分析中可预设 RMST 为关键次要 estimand，并报告 τ 选择依据、置信区间与敏感性分析。',url:'https://doi.org/10.1177/17407745241254995'},
{id:'C03',module:'Bayesian与自适应试验',priority:5,title:'Augmenting External Control Arms Using Bayesian Borrowing: A Case Study in First-Line Non-Small Cell Lung Cancer',authors:'Struebing A, McKibbon C, Ruan H, et al.',journal:'Journal of Comparative Effectiveness Research',year:2024,methods:['external control arm','Bayesian borrowing','power prior','cardinality matching'],question:'单臂肿瘤试验使用真实世界外部对照时，如何在可比性允许的范围内借用外部信息？',data:'ConcertAI 真实世界数据库；一线非小细胞肺癌案例',design:'先以 cardinality matching 构建外部对照，再用 Weibull 比例风险模型和静态 power prior 评估不同借用权重',sample:'案例研究；样本量随匹配和借用权重而变化',flow:'定义目标试验与外部对照资格\\n→ 统一变量和时间零点\\n→ 匹配基线协变量\\n→ 检查外部数据与试验对照相容性\\n→ 设置 power prior 借用权重\\n→ 比较后验效应与不确定性',result:'贝叶斯借用可提高精度，但案例中外部对照未能复现随机试验对照结局，提示借用不能修复未控制混杂或数据源不相容。',innovation:'把匹配后的外部对照与 power prior 放在同一实证框架中，直观展示借用权重、精度和偏倚之间的权衡。',limitations:'静态权重需要主观设定；数据库时间期、随访、后续治疗及未测混杂会造成不可交换性。',reuse:'适合单臂肿瘤试验的补充分析；必须先做相容性诊断，并报告从不借用到较强借用的敏感性范围。',url:'https://doi.org/10.57264/cer-2023-0175'},
{id:'M04',module:'方法规范',priority:5,title:'Evaluation of Clinical Prediction Models (Part 3): Calculating the Sample Size Required for an External Validation Study',authors:'Riley RD, Snell KIE, Archer L, et al.',journal:'BMJ',year:2024,methods:['external validation','sample size','prediction model','precision'],question:'外部验证肿瘤风险预测模型时，需要多少样本和结局事件才能精确估计模型性能？',data:'方法与教学文章；适用于二分类和时间结局预测模型',design:'从目标性能指标的估计精度出发计算外部验证样本量，而非套用固定事件数经验法则',sample:'由结局发生率、预期性能、随访和目标置信区间宽度共同决定',flow:'明确目标人群与结局\\n→ 选择需精确估计的性能指标\\n→ 给出发生率和预期性能\\n→ 设定允许的置信区间宽度\\n→ 计算所需总样本与事件数\\n→ 预留失访和缺失数据',result:'外部验证样本量应围绕校准、区分度和总体风险等关键指标的精度进行规划，不能仅依赖每变量事件数或固定最小样本规则。',innovation:'把预测模型外部验证从经验性样本量判断转为多性能指标驱动的正式设计。',limitations:'计算依赖先验的结局率和模型性能假设；稀有结局、删失、分层评估和模型更新通常需要更大样本。',reuse:'可作为肿瘤预测模型验证方案的样本量依据，并与 TRIPOD+AI、PROBAST+AI 一起使用。',url:'https://doi.org/10.1136/bmj-2023-074821'},
{id:'M05',module:'方法规范',priority:5,title:'Time-to-Event Estimands and Loss to Follow-Up in Oncology in Light of the Estimands Guidance',authors:'Siegel JM, Weber HJ, Englert S, et al.',journal:'Pharmaceutical Statistics',year:2024,methods:['ICH E9(R1)','time-to-event estimand','intercurrent event','dependent censoring'],question:'肿瘤时间结局中，失访、停药和后续治疗应如何纳入 estimand 定义与分析策略？',data:'方法学与监管讨论；聚焦肿瘤 time-to-event 结局',design:'按 ICH E9(R1) 框架连接研究问题、治疗条件、终点、群体汇总及 intercurrent event 策略',sample:'方法学文章，不对应单一固定样本量',flow:'先写清临床问题\\n→ 定义人群与治疗条件\\n→ 确认终点和群体汇总\\n→ 枚举 intercurrent events\\n→ 为每类事件选择策略\\n→ 区分行政删失与潜在信息性失访\\n→ 设计敏感性分析',result:'文章强调删失规则本身不是 estimand；若失访与预后相关，常规独立删失假设可能失效，研究设计、数据收集和分析必须协同。',innovation:'把肿瘤试验中常见的失访和后续治疗问题系统映射到 estimand 框架，澄清治疗策略与删失处理的区别。',limitations:'不同 intercurrent event 策略对应不同临床问题；依赖未观察结局的敏感性分析不能被单一模型完全验证。',reuse:'适合 OS、PFS、EFS 等方案与 SAP 撰写；建议建立 estimand 表，并为潜在信息性删失预设 tipping-point 或其他敏感性分析。',url:'https://doi.org/10.1002/pst.2386'}
];
const METHOD_MAP=[
